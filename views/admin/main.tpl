        ...
        cms.addNav([
            {
                id: 1,
                pid: 0,
                node: '<span style=" font-size: 16px"><i class="layui-icon">&#xe620;</i> 系统管理</span>',
                url: '#'
            },
            {id: 7, pid: 1, node: '&nbsp;&nbsp;&nbsp;系统设置', url: '/admin/config'},
            {
                id: 2,
                pid: 0,
                node: '<span style=" font-size: 16px"><i class="layui-icon">&#xe63c;</i> 内容管理</span>',
                url: '#'
            },
            {id: 3, pid: 2, node: '&nbsp;&nbsp;&nbsp;分类管理', url: '/admin/category'},
            {id: 5, pid: 2, node: '&nbsp;&nbsp;&nbsp;博文列表', url: '/admin/index'},
            {id: 6, pid: 2, node: '&nbsp;&nbsp;&nbsp;博文添加', url: '/admin/article'},
        ], 0, 'id', 'pid', 'node', 'url');
